...
const APP_ID = '03f0a8e0010543679159caa866ff5b99'
...
let rtcUid = UID //Math.floor(Math.random() * 232)
...
let togglevideoshare = async (e) => {
    document.getElementById('sharescreen-btn').innerHTML= "<img class=\"control-icon\" style=\"background-color : lightsalmon ;\" src=\"../static/images/close.svg\" width=\"20px\" height=\"20px\">";
    AutoRefresh(5)
...
//AgoraRTC.createScreenVideoTrack()
        ...
        document.getElementById('sharescreen-btn').innerHTML= "<img class=\"control-icon\" style=\"background-color : lightsalmon ;\" src=\"../static/images/close.svg\" width=\"20px\" height=\"20px\">";
       // e.target.style.backgroundColor = 'rgb(255, 80, 80, 1)'
        //document.getElementById('sharescreen-btn').style.backgroundColor = "#ffcccb";
